package com.mycloud.orderservice.application.service;

import com.mycloud.common.query.GetByIdQuery;
import com.mycloud.orderservice.application.port.in.CreateOrderCommand;
import com.mycloud.orderservice.application.port.in.OrderDetailCommand;
import com.mycloud.orderservice.application.port.in.OrderDetailResult;
import com.mycloud.orderservice.application.port.in.OrderResult;
import com.mycloud.orderservice.application.port.in.OrderStatusView;
import com.mycloud.orderservice.application.port.in.usecase.CreateOrderUseCase;
import com.mycloud.orderservice.application.port.in.usecase.GetOrderUseCase;
...
import com.mycloud.orderservice.domain.OrderStatus;
